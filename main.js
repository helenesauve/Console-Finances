...
// from initial variable, the programme iterates through the months and calculate running total
...
// pushing third value to existing array (given month's profit minus month before)
for (var i = 0; i < months; i++) {
    if (i==0) {
        finances[i].push(finances[i][1]);
    }
    else {
